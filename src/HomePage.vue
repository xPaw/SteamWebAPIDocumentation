		...
		<div class="card">
			...
			<div class="card-body">
				...
				<ol>
					...
					<li>Methods that require a <span class="badge badge-info">user</span> Web API key, available to anyone with a Steam account.</li>
					<li>Protected methods that require a <span class="badge badge-warning">publisher</span> Web API key and return sensitive data or perform protected actions.</li>
				</ol>
				...
				<div class="table-wrap">
					<table class="data-table">
						...
						<tbody>
							...
							<tr><td class="mono">400</td><td>Bad Request: missing or incorrect required parameters.</td></tr>
							<tr><td class="mono">401</td><td>Unauthorized: invalid or missing API key.</td></tr>
							<tr><td class="mono">403</td><td>Forbidden: the API key does not have permission for the requested method.</td></tr>
							<tr><td class="mono">404</td><td>Not Found: the requested API endpoint does not exist.</td></tr>
							<tr><td class="mono">405</td><td>Method Not Allowed: the HTTP method (GET/POST) used is not allowed for this endpoint.</td></tr>
							<tr><td class="mono">429</td><td>Too Many Requests: you are being rate limited.</td></tr>
							<tr><td class="mono">500</td><td>Internal Server Error: an unexpected server error occurred, try again later.</td></tr>
							<tr><td class="mono">502</td><td>Bad Gateway: the server received an invalid response from an upstream server.</td></tr>
							<tr><td class="mono">503</td><td>Service Unavailable: the server is temporarily offline, try again later.</td></tr>
							<tr><td class="mono">504</td><td>Gateway Timeout: the server did not receive a timely response from an upstream server.</td></tr>
						</tbody>
					</table>
				</div>
